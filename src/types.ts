...
export type WeeklyTimePolicy={enabled:boolean;allowanceMinutes:number;resetDay:Weekday;automaticSuspensionEnabled:boolean;overageGraceMinutes:number;suspensionDays:number;updatedAt?:string};
