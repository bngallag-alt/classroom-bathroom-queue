...
export type WeeklyTimePolicy={enabled:boolean;allowanceMinutes:number;resetDay:Weekday;warningRemainingMinutes:number;automaticSuspensionEnabled:boolean;overageGraceMinutes:number;suspensionDays:number;updatedAt?:string};
